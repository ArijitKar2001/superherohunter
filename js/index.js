...
xhrRequest.open(
  "get",
  "https://gateway.marvel.com/v1/public/comics?ts=1&apikey=b95f70c57d199e7dc5539edeacd50ab6&hash=dc095909d0f722c3d7a8a77d3ec2ac7c",
  true
);
xhrRequest.send();
...
function getUrl() {
  ...
  if (!searchQuery) {
    return "https://gateway.marvel.com/v1/public/comics?ts=1&apikey=b95f70c57d199e7dc5539edeacd50ab6&hash=dc095909d0f722c3d7a8a77d3ec2ac7c";
  } else {
    return `https://gateway.marvel.com/v1/public/characters?nameStartsWith=${searchQuery}&ts=1&apikey=b95f70c57d199e7dc5539edeacd50ab6&hash=dc095909d0f722c3d7a8a77d3ec2ac7c`;
  }
}
